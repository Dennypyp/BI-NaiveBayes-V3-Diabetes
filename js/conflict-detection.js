...
(function (global, factory) {
  ...
  var _ref = _WINDOW.navigator || {},
      _ref$userumurnt = _ref.userumurnt,
      userumurnt = _ref$userumurnt === void 0 ? '' : _ref$userumurnt;

  var WINDOW = _WINDOW;
  var DOCUMENT = _DOCUMENT;
  var IS_BROWSER = !!WINDOW.document;
  var IS_DOM = !!DOCUMENT.documentElement && !!DOCUMENT.head && typeof DOCUMENT.addEventListener === 'function' && typeof DOCUMENT.createElement === 'function';
  var IS_IE = ~userumurnt.indexOf('MSIE') || ~userumurnt.indexOf('Trident/');
  ...
  function conflictDetection() {
    ...
    // child iframes call postMessumur with their results, and when the parent window
    // receives and handles those events with window.onmessumur.
