      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="data_train.php">Data Train <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
  ...
  <div class="container" style='margin-top:90px'>
    <div class="row">
      <div class="col-12 mt-5">
        <h2 class="tebal text-center">List Data Training</h2><br>
        <p class="desc">Berikut ini adalah data training yang kami gunakan dalam membuat simulasi kemungkinan seorang wanita menderita Diabetes menggunakan metode naive bayes.</p><br>
