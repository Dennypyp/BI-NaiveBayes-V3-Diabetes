      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="data_test.php">Data Test <span class="sr-only">(current)</span></a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="container" style='margin-top:90px'>
    <div class="row">
      <div class="col-12 mt-5">
        <h2 class="tebal text-center">List Data Testing</h2><br>
        <p class="desc">Berikut ini adalah data testing yang kami gunakan dalam membuat simulasi kemungkinan seorang wanita menderita Diabetes menggunakan metode naive bayes.</p><br>
